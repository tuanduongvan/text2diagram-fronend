...
/**
 * Make rectangle colorful
 */
export const decorateRectangle = (element: ExcalidrawElementSkeleton) => {
  element.strokeColor = '#4dabf7';
};

/**
 * Make ellipse colorful
 */
export const decorateEllipse = (element: ExcalidrawElementSkeleton) => {
  element.strokeColor = '#2f9e44';
};

/**
 * Make diamond colorful
 */
export const decorateDiamond = (element: ExcalidrawElementSkeleton) => {
  element.strokeColor = '#fab005';
};

/**
 * Make line colorful
 */
export const decorateLine = (element: ExcalidrawElementSkeleton) => {
  element.strokeColor = '#2f9e44';
};
 ...
 * Make text colorful
 */
export const decorateText = (element: ExcalidrawElementSkeleton) => {
